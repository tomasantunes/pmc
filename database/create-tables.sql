...
ALTER TABLE tasks ADD days VARCHAR(512) DEFAULT '';
ALTER TABLE tasks DROP COLUMN week_day;
...
ALTER TABLE tasks ADD COLUMN start_time DATETIME DEFAULT NULL;
ALTER TABLE tasks ADD COLUMN end_time DATETIME DEFAULT NULL;